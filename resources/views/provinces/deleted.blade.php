                    ...
                    <div class="container">
                        <div class="input-group mb-3">
                            <div class="btn-group" role="group" aria-label="Basic outlined example">
                                <a href="{{ route('provinces.index') }}" id="" class="btn btn-outline-primary" type="button">
                        ...
                        @foreach ($provinces as $province)
                            <tr>
                                ...
                                <td class="align-middle text-center">
                                    <a class="btn btn-outline-primary" href="{{route('provinces.unlock', $province->province_id)}}">
                                        <i class="bi bi-unlock"></i>
                                        Phục hồi
                                    </a>

                                    <a class="btn btn-outline-danger" href="{{route('provinces.destroy', $province->province_id)}}" onclick="return confirm('Chắc là xoá')">
